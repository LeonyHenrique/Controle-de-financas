...
namespace ControleFacil.Api.Damain.Services.Interfaces
{
    ...
    /// </summary>
    /// <typeparam name="RQ">Contrato de request</typeparam> // ele recebe um contrato de request
    /// <typeparam name="RS">Contrato de response</typeparam> // sempre devolve um response
